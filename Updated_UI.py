...
def classify_issue(text):
    ...
    if "payment" in text_lower or "bill" in text_lower or "charge" in text_lower:
    ...
    elif "login" in text_lower or "account" in text_lower or "password" in text_lower:
        return "Account", "Login Issue"
    else:
        return "General", "Other"

# -------------------------------
# IMPROVED SENTIMENT + URGENCY
# -------------------------------
def analyze_sentiment(text):
    text_lower = text.lower()

    # Keyword-based sentiment (fix for short tickets)
    if any(word in text_lower for word in ["fail", "failed", "error", "crash", "not working", "issue", "problem"]):
        sentiment = "Negative"
    elif any(word in text_lower for word in ["good", "great", "love", "excellent", "amazing"]):
        sentiment = "Positive"
    else:
        blob = TextBlob(text)
    ...
    # Urgency logic
    if "urgent" in text_lower or "asap" in text_lower or sentiment == "Negative":
        urgency = "High"
